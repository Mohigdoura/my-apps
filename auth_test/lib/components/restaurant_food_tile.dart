...
class RestaurantFoodTile extends ConsumerWidget {
  final MenuItem menuItem;
  const RestaurantFoodTile({super.key, required this.menuItem});
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text("${menuItem.name} has been deleted"),
    ...
    return Card(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                menuItem.isavailable ? Colors.transparent : Colors.red.shade200,
