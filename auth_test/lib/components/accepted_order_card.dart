...
class AcceptedOrderCard extends ConsumerStatefulWidget {
  final OrderModel order;

  const AcceptedOrderCard({required this.order, super.key});

  @override
  ConsumerState<AcceptedOrderCard> createState() => _AcceptedOrderCardState();
}

class _AcceptedOrderCardState extends ConsumerState<AcceptedOrderCard> {
